...
{
    /// <inheritdoc />
    public partial class ShopFinaltest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalDiscount = table.Column<int>(type: "int", nullable: false),
                    FinalPriceWithDiscount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPriceWithDiscount = table.Column<int>(type: "int", nullable: false),
                    DiscountCode = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DiscountCode = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateDate", "Email", "EmailActiveCode", "FullName", "ImageName", "IsAdmin", "IsBan", "IsDelete", "IsEmailActive", "Mobile", "Password" },
                values: new object[] { 1, new DateTime(2023, 12, 8, 14, 8, 33, 201, DateTimeKind.Local).AddTicks(7403), "998877123azaz@gmail.com@gmail.com", "d5081c536cf0433fa68df6189d087448", "", null, true, false, false, true, null, "96-E7-92-18-96-5E-B7-2C-92-A5-49-DD-5A-33-01-12" });
